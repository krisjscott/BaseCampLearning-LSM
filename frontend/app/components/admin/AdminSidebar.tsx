...
import { Gauge, LayoutDashboard, ListChecks, LogOut, Menu, ShieldCheck, UsersRound, X } from "lucide-react";
import Link from "next/link";
import { useEffect, useState } from "react";
import { logout, UserResponse } from "../../lib/backendApi";
import { SUPER_ADMIN_ROLE } from "../../lib/adminApi";

const ADMIN_ROOT = "/admin-7f3k9x2q";

const baseNavItems = [
  { label: "Learners", href: `${ADMIN_ROOT}/learners`, icon: UsersRound },
  { label: "Courses", href: `${ADMIN_ROOT}/courses`, icon: LayoutDashboard },
  { label: "Quiz & Contests", href: `${ADMIN_ROOT}/quizzes`, icon: ListChecks },
] as const;

const superAdminNavItems = [
  { label: "Dashboard", href: ADMIN_ROOT, icon: Gauge },
  ...baseNavItems,
] as const;
